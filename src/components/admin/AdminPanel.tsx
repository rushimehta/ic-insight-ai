...
import { Users, Shield, Building2, Search, Plus, Trash2, Loader2, Save, AlertTriangle } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="opacity-0 animate-fade-in">
        ...
        <p className="text-muted-foreground mt-1">
          Manage user roles and sector access permissions
        </p>
      </div>

      {/* Info Banner */}
      <div className="glass rounded-xl p-4 flex items-start gap-3 opacity-0 animate-fade-in" style={{ animationDelay: "50ms" }}>
                      ...
                      return (
                        <label
                          ...
                          className={cn(
                            ...
                            hasFullAccess || selectedUser.sectors.includes(sector.value)
                              ? "bg-primary/10 border-primary/30"
                              : "border-border hover:bg-secondary/50",
                        ...
                        >
                          <Checkbox
                            checked={hasFullAccess || selectedUser.sectors.includes(sector.value)}
                            disabled={hasFullAccess}
                            onCheckedChange={(checked) => 
                              handleSectorToggle(selectedUser.id, sector.value, checked as boolean)
                            }
                          />
